<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebConsultantEdit.aspx.cs" Inherits="WebConsultantEdit" %>
                       ...
                       <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0"  CssClass="pageView" Width="940px">
                            <telerik:RadPageView ID="RadPageView1" runat="server">
                               <div class="form-horizontal" style="padding-top:20px;">
                                  ...
                                  <div style="float:left; width:750px;">
                                    ...
                                    <div class="control-group">
                                        <asp:Label ID="lblBiografia" runat="server" Text="Bioshock" 
                                        CssClass="control-label" meta:resourcekey="lblBiografia" 
                                            AssociatedControlID="txtBiografia"></asp:Label>
                                        <div class="controls">
                                              <asp:TextBox ID="txtBiografia" runat="server" TextMode="MultiLine"  Width="330px" Rows="3"></asp:TextBox>
                                        </div>                        
                                    </div>
                                    ...
                                    <div style="width: 930px;">
                                        <div style="float: left; width: 600px;">                                                      
                                           ...
                                           <div class="control-group">
                                            ...
                                            <div id="divFechaActualizacion" class="control-group" runat="server">
                                                <span class="control-label">
                            ...
                            <telerik:RadPageView ID="RadPageView5" runat="server">
                               ...
                               <div style="padding-top:20px;padding-left:10px;padding-right:10px;">
                                    ...
                                    <telerik:RadGrid ID="gridReferencia" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Culture="es-ES" Width="100%" Height="220px" onitemcommand="gridReferencia_ItemCommand">
                                        <ClientSettings EnableRowHoverStyle="true" ></ClientSettings>
                                        <MasterTableView NoMasterRecordsText="No records to display." meta:resourcekey="lblNoDato" >
                                            <CommandItemSettings ExportToPdfText="Export to PDF" />
                                            ...
                                            <Columns>
                                                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="temSel" HeaderText="" HeaderStyle-Width="20px">
                                                    <ItemTemplate>
                                                 ...
                                                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="temCompania" HeaderText="Compania" meta:resourcekey="ColCompania" HeaderStyle-Width="100px">
                                                    <ItemTemplate>                                         
                                                 ...
                                                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="temPais"  HeaderText="Pais" meta:resourcekey="ColPais" HeaderStyle-Width="100px">
                                                    <ItemTemplate>                     
                                                 ...
                                                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="temContacto"  HeaderText="Contacto" meta:resourcekey="ColContacto" HeaderStyle-Width="80px">
                                                    <ItemTemplate>
                                                 ...
                                                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="temPuesto"  HeaderText="Puesto" meta:resourcekey="ColPuesto" HeaderStyle-Width="80px">
                                                    <ItemTemplate>                                           
                                                 ...
                                                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="temTelefono"  HeaderText="Telefono" meta:resourcekey="ColTelefono" HeaderStyle-Width="60px">
                                                    <ItemTemplate>                                           
                                                 ...
                                                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="temCorreo"  HeaderText="Contacto" meta:resourcekey="ColCorreo" HeaderStyle-Width="60px">
                                                    <ItemTemplate>
